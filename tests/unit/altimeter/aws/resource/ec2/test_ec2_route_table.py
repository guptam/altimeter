    ...
    def test_schema_parse(self):
        ...
        expected_alti_resource_dict = {
            ...
            "links": [
                ...
                {"pred": "owner_id", "obj": "210554966933", "field_type": "simple"},
                {
                    "pred": "route",
                    "obj": [
                        {
                        ...
                        {"pred": "gateway_id", "obj": "local", "field_type": "simple"},
                        {"pred": "origin", "obj": "CreateRouteTable", "field_type": "simple"},
                        {"pred": "state", "obj": "active", "field_type": "simple"},
                    ],
                    "field_type": "multi",
                },
                {
                    "pred": "route",
                    "obj": [
                        {"pred": "destination_cidr_block", "obj": "0.0.0.0/0", "field_type": "simple"},
                        {"pred": "gateway_id", "obj": "igw-092e5ec1685fd0c0b", "field_type": "simple"},
                        {"pred": "origin", "obj": "CreateRoute", "field_type": "simple"},
                        {"pred": "state", "obj": "active", "field_type": "simple"},
                    ],
                    "field_type": "multi",
                },
                {
                    ...
                    "obj": [
                        ...
                        {"pred": "gateway_id", "obj": "vpce-0678bce2b63b8ad0f", "field_type": "simple"},
                        {"pred": "origin", "obj": "CreateRoute", "field_type": "simple"},
                        {"pred": "state", "obj": "active", "field_type": "simple"},
                    ],
                    "field_type": "multi",
                },
                {
                    "pred": "association",
                    "obj": [
                        {"pred": "main", "obj": False, "field_type": "simple"},
                        {
                        ...
                        {"pred": "subnet_id", "obj": "subnet-00f9fe55b9d7ca4fb", "field_type": "simple"},
                    ],
                    "field_type": "multi",
                },
                {
                    ...
                    "obj": [
                        ...
                        {"pred": "subnet_id", "obj": "subnet-0b98092b454c882cf", "field_type": "simple"},
                    ],
                    "field_type": "multi",
                },
            ],
