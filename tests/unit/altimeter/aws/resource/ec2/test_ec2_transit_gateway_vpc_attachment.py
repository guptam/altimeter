    ...
    def test_schema_parse(self):
        ...
        expected_alti_resource_dict = {
            ...
            "links": [
                ...
                {"pred": "transit_gateway_id", "obj": "tgw-086b599bebfee5d40", "link_type": "simple"},
                {"pred": "vpc_id", "obj": "vpc-01e8457e8c00c40a7", "link_type": "simple"},
                {"pred": "vpc_owner_id", "obj": "123456789012", "link_type": "simple"},
                ...
                {"pred": "dns_support", "obj": "enable", "link_type": "simple"},
                {"pred": "ipv6_support", "obj": "disable", "link_type": "simple"},
            ],
        }
